---
title: "A cartoon example for host connectivity with geohabnet"
author: "Aaron I. Plex"
...
The objective of this exercise is to show the underlying assumptions to calculate habitat connectivity in the `geohabnet` package using a simple example.
...
Imagine your PI asked you to run the host landscape connectivity for many beta parameter values, using different dispersal kernels, multiple link thresholds and multiple network metrics. Fortunately, geohabnet provides a easy way of conducting that "complicated" analysis in a single function (so just give it five minutes to run).
